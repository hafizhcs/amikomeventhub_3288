    ...
    public function store(Request $request)
{
    ...
    if ($request->hasFile('poster')) {
     ...
     // Event yang dibuat langsung oleh superadmin tidak perlu antre review.
     $data['organizer_id'] = auth()->id();
     $data['status'] = \App\Models\Event::STATUS_APPROVED;
    ...
    public function update(Request $request, Event $event)
{
   $data = $request->validate([
    ...
    /**
     * REVIEW - Daftar event yang diajukan organizer, menunggu approval Superadmin
     */
    ...
    {
        $event->update(['status' => Event::STATUS_APPROVED, 'rejection_reason' => null]);

        return back()->with('success', 'Event "' . $event->title . '" disetujui dan sudah tayang.');
    }
